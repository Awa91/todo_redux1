...
import { removeTodo, removeAllTodo } from '../Features/todo/todoslice';

function Addtodo({ handleEdit }) {
  ...
  return (
    <>
      ...
      <ul className="list-none">
        ...
        {todos.length != 0 ? <li><button onClick={() => { dispatch(removeAllTodo()) }} className='w-full mt-4'>deleteAll</button></li> : null}
